...
// Remove dynamic export, rely on Suspense
// export const dynamic = 'force-dynamic';

// Inner component that uses useSearchParams
function SignUpFormAndMessages() {
  ...
  // Render the form if no success/info message
  return (
...
// Main export component remains simple
